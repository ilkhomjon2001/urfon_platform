...
const Admin = {
  ...
  LessonPlans: lazy(() => import("@/pages/admin/LessonPlans")),
  Resources: lazy(() => import("@/pages/admin/Resources")),
...
const Teacher = {
  ...
  LessonPlans: lazy(() => import("@/pages/teacher/LessonPlans")),
  ...
  [
    {
      ...
      children: [
        ...
        roleTree("ADMIN", [
          ...
          { path: "dars-rejalari", element: <Admin.LessonPlans /> },
          { path: "resurslar", element: <Admin.Resources /> },
        ...
        roleTree("TEACHER", [
          ...
          { path: "dars-rejalari", element: <Teacher.LessonPlans /> },
